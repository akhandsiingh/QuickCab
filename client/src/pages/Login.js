    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden transform transition-all duration-500 ease-in-out animate-fadeIn">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 py-6">
          ...
          <h2 className="text-center text-3xl font-extrabold text-white">Login to QuickCab</h2>
        </div>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  value={email}
                  onChange={onChange}
                  className="pl-10 block w-full py-3 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div className="transform transition-transform duration-200 hover:scale-105 active:scale-95">
                <Link
                  to="/driver/login"
                  className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-md shadow-sm bg-gradient-to-r from-green-500 to-green-600 text-sm font-medium text-white hover:from-green-600 hover:to-green-700 transition-all duration-200"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="transform transition-transform duration-200 hover:scale-105 active:scale-95">
                <Link
                  to="/admin/login"
                  className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-md shadow-sm bg-gradient-to-r from-purple-500 to-purple-600 text-sm font-medium text-white hover:from-purple-600 hover:to-purple-700 transition-all duration-200"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2"
